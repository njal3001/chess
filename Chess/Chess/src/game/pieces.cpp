...
namespace Game
{
    ...
    std::vector<Move> King::valid_moves() const
    {
        return get_spot_moves({Vec2i(1, 0), Vec2i(1, 1), Vec2i(1, -1), 
    ...
    {
        return m_was_moved_prev_turn && abs(m_pos.y - m_prev_pos.y) == 2;
    }
    ...
    std::vector<Move> Bishop::valid_moves() const
    {
    ...
    std::vector<Move> Knight::valid_moves() const
    {
        ...
        return get_spot_moves(offsets, false, false);
    }
    ...
    std::vector<Move> Rook::valid_moves() const
    {
        std::vector<Vec2i> step_dirs = 
        {
            Vec2i(1, 0),
    ...
    std::vector<Move> Queen::valid_moves() const
    {
        std::vector<Vec2i> step_dirs = 
        {
            Vec2i(1, 0),
